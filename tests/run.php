...
namespace {
    ...
    $assert(
        ...
        && str_contains($webrickSwooleSource, "\$GLOBALS['benchmark_webrick_started_at'] = \$startedAt")
        && str_contains($webrickSwooleSource, "unset(\$GLOBALS['benchmark_webrick_started_at'])")
        && !str_contains($webrickSwooleSource, 'Response::create(')
        && is_string($swooleEntrypointSource)
    ...
    $assert(
        ...
        && str_contains($webrickFrontController, '$kernel->handle()')
        && str_contains($webrickFrontController, '(new DefaultEmitter())->emit($response)')
        && !str_contains($webrickFrontController, 'Request::fromGlobals()')
        && !str_contains($webrickFrontController, 'emit($response, $request)')
        ...
        && str_contains($webrickHandler, "\$GLOBALS['benchmark_webrick_started_at']")
        && str_contains($webrickHandler, "'Hello World!' . \$telemetry")
